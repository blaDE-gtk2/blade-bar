...
#ifndef __LIBBLADEBAR_ENUMS_H__
#define __LIBBLADEBAR_ENUMS_H__
 ...
 * @short_description: Standard enumerations used by the Blade Bar.
...
/**
 * BladeBarPluginMode
 * @BLADE_BAR_PLUGIN_MODE_HORIZONTAL : Horizontal bar and plugins
 * @BLADE_BAR_PLUGIN_MODE_VERTICAL   : Vertical rotated bar and plugins
 * @BLADE_BAR_PLUGIN_MODE_DESKBAR    : Vertical bar with horizontal plugins
 *
 * Orientation of the plugin in the bar.
 *
 * Since: 4.10
 **/
typedef enum /*<enum,prefix=BLADE_BAR_PLUGIN_MODE >*/
{
