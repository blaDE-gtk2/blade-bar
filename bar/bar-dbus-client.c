...
#include <bar/bar-dbus-client-infos.h>
...
static DBusGProxy *
bar_dbus_client_get_proxy (GError **error)
{
...
gboolean
bar_dbus_client_display_preferences_dialog (guint         active,
                                              ...
                                              GError      **error)
{
  ...
  dbus_proxy = bar_dbus_client_get_proxy (error);
  if (G_LIKELY (dbus_proxy == NULL))
    return FALSE;

  result = _bar_dbus_client_display_preferences_dialog (dbus_proxy,
                                                          active, socket_id,
                                                          error);
...
gboolean
bar_dbus_client_display_items_dialog (guint    active,
                                        GError **error)
{
  gboolean    result;
  DBusGProxy *dbus_proxy;
  ...
  result = _bar_dbus_client_display_items_dialog (dbus_proxy, active,
                                                    error);
...
gboolean
bar_dbus_client_save (GError **error)
{
  DBusGProxy *dbus_proxy;
  gboolean    result;
  ...
  result = _bar_dbus_client_save (dbus_proxy, error);
...
gboolean
bar_dbus_client_add_new_item (const gchar  *plugin_name,
                                gchar       **arguments,
                                GError      **error)
{
  DBusGProxy *dbus_proxy;
  ...
  result = _bar_dbus_client_add_new_item (dbus_proxy, plugin_name,
...
static GType
bar_dbus_client_gtype_from_string (const gchar *str)
{
...
gboolean
bar_dbus_client_plugin_event (const gchar  *plugin_event,
                                ...
                                GError      **error)
{
  ...
  if (!(n_tokens == 2 || n_tokens == N_TOKENS)
      || blxo_str_is_empty (tokens[PLUGIN_NAME])
      || blxo_str_is_empty (tokens[NAME]))
    {
    ...
    {
      type = bar_dbus_client_gtype_from_string (tokens[TYPE]);
  ...
  result = _bar_dbus_client_plugin_event (dbus_proxy,
                                            tokens[PLUGIN_NAME],
                                            tokens[NAME],
                                            &value,
                                            return_succeed,
...
gboolean
bar_dbus_client_terminate (gboolean   restart,
                             GError   **error)
{
  DBusGProxy *dbus_proxy;
  gboolean    result;
  ...
  result = _bar_dbus_client_terminate (dbus_proxy, restart, error);
